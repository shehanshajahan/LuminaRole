...
```bash
git clone https://github.com/your-username/luminarole-ai.git
cd luminarole-ai
```
...
[![Star on GitHub](https://img.shields.io/github/stars/your-username/luminarole-ai?style=social)](https://github.com/your-username/luminarole-ai)
